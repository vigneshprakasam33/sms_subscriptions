class SupportsController < ApplicationController
  skip_before_filter :require_login, :only => [:new, :create, :update]
  ...
  def create
    ...
    respond_to do |format|
      if @support.save
        UserMailer.send_feedback(@support).deliver
        format.html { redirect_to new_support_path, notice: 'Thanks for contacting us. We will respond to you soon.' }
